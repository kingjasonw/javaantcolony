...
public class AntSimGUI extends JFrame
{
	...
	// alert message when simulation ends
	public void simulationEnded() {
		JOptionPane.showMessageDialog(null, "The Queen is dead. The Simulation has ended.", "Simulation Ended", JOptionPane.WARNING_MESSAGE);
	}
